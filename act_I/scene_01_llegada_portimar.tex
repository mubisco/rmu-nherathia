...
\begin{imagerim}
\includegraphics[width=\linewidth]{images/portimar.png}
\end{imagerim}
...
\begin{npcsheet}[Capitán del barco][images/marn_velkan.png]{Marn Velkan}
  ...
  \secrets{Sabe que los últimos barcos ``extranjeros'' fueron retenidos días enteros. No piensa intervenir cuando comiencen los arrestos.}
\end{npcsheet}
...
\begin{npcsheet}[Guardia del Silente][images/guardia_silente.png]{Vigilante Sereth}
