...
\subsubsection*{Cierre de la escena: El Procesamiento}
...
Son llevados a una antecámara desnuda en la **Casa del Silencio**. Allí, bajo la mirada impasible de los Vigías, se les despoja de todo: armas, armaduras, símbolos sagrados y bolsas.

Un escriba anota cada objeto en un libro de piel gris, pero no anota sus nombres.

\begin{displayquote}
\emph{"Estos objetos pertenecen al mundo material. Vosotros ya no."}
\end{displayquote}

Antes de ser empujados a la oscuridad de los niveles inferiores, el Vigilante Sereth dicta la sentencia con voz monótona, sin mirarles a los ojos:

\begin{displayquote}
\emph{"Vuestra presencia genera ruido. Al amanecer, seréis silenciados para restaurar la armonía. Aprovechad estas horas para olvidar quiénes fuisteis."}
\end{displayquote}

Con la certeza de su ejecución al alba, son arrastrados a las celdas.

\textbf{Comienza la Escena II — El Viejo en la Celda.}
\end{multicols}
